...
with torch.no_grad():
    ...
    for emo_i in range(6):
        ...
        aa = frame_list[:-args.offset, ...]
        bb = speech[0, 0, :int(-args.offset*args.increment)]
        cc = sr
        dd = output_path
        print(emotion_dict)
        ee = emotion_dict[emo_i]
        ...
        utils.write_video_cv(aa,bb,cc,dd,ee+'_generated.mp4', args.fps)
