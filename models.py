...
class IMGENCODER(nn.Module):
    def __init__(self, args, in_dim=3):
        ...
        # print(self.args.deform)
        # print("$$$$$$$$$$$$$$$$$$$")
        if(int(self.args.deform)==1):
          # print("kkkk")
          print("$$%$%%")
          # print("%%%%%%%%%%%%%")
          self.convde = DeformableConv2d(self.args.img_dim, self.args.img_dim, kernel_size=3, stride=1)

          self.att = nn.Conv2d(self.args.img_dim, self.args.img_dim, kernel_size=1, stride=1)
          self.rel1 = nn.ReLU()
